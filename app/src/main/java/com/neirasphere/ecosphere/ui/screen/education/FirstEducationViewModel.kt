...
class FirstEducationViewModel(
        ...
        private val _firstEducation : MutableStateFlow<UiState<List<com.neirasphere.ecosphere.domain.model.FirstEducationData>>> = MutableStateFlow(
            UiState.Loading
        )

    val firstEducation : StateFlow<UiState<List<com.neirasphere.ecosphere.domain.model.FirstEducationData>>>
        get() = _firstEducation
